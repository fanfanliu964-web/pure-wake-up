...
#   * DEFAULT://JVM://OPTS://and JAVA_OPTS can be://unset://in ANT_OPTS
#
...
#     of shell script including quotes and are://therefore not://safe://to eval
#     directly as a command.
#   * The quoting://here://is://fragile.://It://will://break://if://any://arg://has://spaces.
exec "$JAVACMD" \
    $DEFAULT_JVM_OPTS \
    $JAVA_OPTS \
    $GRADLE_OPTS \
